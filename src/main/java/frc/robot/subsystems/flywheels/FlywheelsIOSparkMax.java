...
public class FlywheelsIOSparkMax implements FlywheelsIO {
  ...
  public FlywheelsIOSparkMax() {
    // Init Hardware
    leftMotor = new CANSparkMax(flywheelConfig.leftID(), CANSparkMax.MotorType.kBrushless);
    rightMotor = new CANSparkMax(flywheelConfig.rightID(), CANSparkMax.MotorType.kBrushless);
